  ...
  return (
    <footer className="bg-amber-900 text-amber-50 pt-16 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 pt-8 border-t border-amber-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-amber-200 text-sm font-sans">
            &copy; {new Date().getFullYear()} ChaiBite Biscuits. All rights
            reserved.
          </p>
          <div className="flex space-x-6 mt-6 md:mt-0">
            <a
              href="#"
              className="text-amber-200 hover:text-amber-300 transition-colors duration-300"
            >
