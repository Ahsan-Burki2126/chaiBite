      ...
      <section className="py-20 px-6 sm:px-8 bg-gradient-to-r from-amber-800 to-amber-700 text-white">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-amber-100 max-w-3xl mx-auto font-sans leading-relaxed">
            We're here to help with any questions about our artisanal biscuits
          </p>
        </div>
      </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-5 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-amber-800 text-white py-4 px-6 rounded-lg hover:bg-amber-900 transition-colors text-lg font-medium shadow-md"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="mt-20">
          ...
          <div className="bg-white p-1 rounded-xl shadow-xl overflow-hidden">
            <iframe
              ...
              title="ChaiBite Bakery Location"
            ></iframe>
          </div>
        </div>
      </div>
